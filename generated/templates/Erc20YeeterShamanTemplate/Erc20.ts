...
export class Erc20__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Erc20__getCheckpointResultValue0Struct extends ethereum.Tuple {
...
export class Erc20 extends ethereum.SmartContract {
  ...
  checkpoints(param0: Address, param1: BigInt): Erc20__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Erc20__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<Erc20__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint256):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Erc20__checkpointsResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  getCheckpoint(
    delegatee: Address,
    nCheckpoints: BigInt,
  ): Erc20__getCheckpointResultValue0Struct {
    let result = super.call(
      "getCheckpoint",
      "getCheckpoint(address,uint256):((uint32,uint256))",
      [
        ethereum.Value.fromAddress(delegatee),
        ethereum.Value.fromUnsignedBigInt(nCheckpoints),
      ],
    );

    return changetype<Erc20__getCheckpointResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getCheckpoint(
    delegatee: Address,
    nCheckpoints: BigInt,
  ): ethereum.CallResult<Erc20__getCheckpointResultValue0Struct> {
    let result = super.tryCall(
      "getCheckpoint",
      "getCheckpoint(address,uint256):((uint32,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Erc20__getCheckpointResultValue0Struct>(value[0].toTuple()),
    );
  }
