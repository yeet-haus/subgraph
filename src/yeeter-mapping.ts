...
import { OnReceivedERC20 } from "../generated/templates/Erc20YeeterShamanTemplate/Erc20YeeterShaman";
...
export function handleOnReceivedErc20(event: OnReceivedERC20): void {
  const yeeter = Yeeter.load(event.address.toHexString());
